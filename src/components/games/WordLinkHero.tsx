...
export default function WordLinkHero() {
  ...
  if (!isLoaded) return <div className="min-h-[90vh] bg-slate-950" />;
  ...
  return (
    <>
          ...
          <div className="max-w-6xl w-full mx-auto relative z-10 grid lg:grid-cols-[1fr_300px] gap-6 items-center">
            ...
            <div className="flex flex-col gap-4 h-full justify-start">
              <div className="bg-indigo-600 p-8 rounded-[2rem] shadow-xl text-white text-left">
                <p className="text-[10px] font-black uppercase tracking-widest opacity-80 mb-1 text-left">
                  Completion
                </p>
                <h3 className="text-4xl font-black italic text-left">
                  {Math.round(
      ...
      {foundWords.length === LEVEL_DATA.words.length && (
        <div className="fixed inset-0 bg-slate-950/95 backdrop-blur-2xl z-[100] flex items-center justify-center p-6 text-center">
