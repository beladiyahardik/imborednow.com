...
export default function About() {
  return (
    <>
      <Head>
        <title>
          About Us | The Original Bored Button & Games to Play When Bored
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="about bored button, games to play when bored, red button website, websites when bored, fun button game"
        />
        ...
        <section className="relative overflow-hidden bg-slate-900 py-24 sm:py-32">
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <p className="text-xl sm:text-2xl text-slate-300 max-w-3xl mx-auto font-medium">
              We are a global team of developers dedicated to solving the
              world&apos;s most common problem:{" "}
              <span className="text-white italic">&quot;I am bored.&quot;</span>
            </p>
          </div>
        </section>
              ...
              <div className="lg:col-span-8 space-y-12">
                <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-sm border border-slate-100">
                  ...
                  <div className="prose prose-slate prose-lg text-slate-600 leading-relaxed">
                    <p>
                      Started by a small group of creative developers,{" "}
                      <strong>I&apos;m Bored Now</strong> was built with a
                      single goal: to curate the internet&apos;s most
                      entertaining &quot;rabbit holes.&quot; We realized that
                      while the internet is vast, finding{" "}
                      <strong>fun games to play while bored</strong> often feels
                      like a chore.
                    </p>
                    <p>
                      We developed our version of the{" "}
                      <strong>red button website</strong> to act as a digital
                      teleportation device. Every time you click, our algorithm
                      selects a hand-picked experience—ranging from{" "}
                      <strong>old internet games</strong> to mind-bending
                      trivia—ensuring you never see the same thing twice in a
                      row.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-8">
                    <div className="space-y-3">
                      ...
                      <p className="text-slate-500 text-sm">
                        Our developers manually vet every{" "}
                        <strong>boredom-killing website</strong> for safety,
                        speed, and fun-factor before it enters our database.
                      </p>
                    </div>
                    <div className="space-y-3">
                      ...
                      <p className="text-slate-500 text-sm">
                        Whether you are <strong>bored at school</strong> or
                        work, our content is designed to be accessible and
                ...
                <div className="bg-slate-50 p-8 md:p-12 rounded-[2.5rem] border border-slate-200">
                  <h2 className="text-2xl font-black text-slate-900 mb-4 flex items-center gap-3">
                    <span className="text-blue-600">i</span> Advertising & DART
                    Policy
                  </h2>
                  <div className="text-sm text-slate-600 space-y-4 font-medium">
                    <p>
                      To help keep our <strong>random button game</strong> free
                      for everyone, we use third-party advertising companies to
                      serve ads when you visit our website.
                    </p>
                    <ul className="list-disc pl-5 space-y-2">
                      <li>
                        <strong>Google DART Cookie:</strong> Google, as a
                        third-party vendor, uses cookies to serve ads on our
                        site. Google&apos;s use of the DART cookie enables it to
                        serve ads to our users based on their visit to our sites
                        and other sites on the Internet.
                      </li>
                      <li>
                        <strong>Opting Out:</strong> Users may opt out of the
                        use of the DART cookie by visiting the Google ad and
                        content network privacy policy.
                      </li>
                      <li>
                        <strong>Transparency:</strong> We do not sell your
                        personal data. Our ads are served to provide{" "}
                        <strong>websites when bored</strong> enthusiasts with a
                        high-quality, free experience.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="lg:col-span-4 space-y-8">
                <div className="bg-gradient-to-br from-purple-600 to-indigo-700 p-8 rounded-[2.5rem] text-white shadow-xl">
                  ...
                  <p className="text-purple-100 text-sm leading-relaxed mb-6">
                    We are a collective of UX designers and Full-stack
                    developers who believe the <strong>bored button</strong> is
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-center justify-between group">
                      ...
                      <a
                        href="https://www.linkedin.com/in/beladiya-hardik/"
                        target="_blank"
                    ...
                    <div className="flex items-center justify-between group">
                      ...
                      <a
                        href="https://www.linkedin.com/in/piyush-koladiya-079496248/"
                        target="_blank"
                        className="p-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors"
                        aria-label="LinkedIn Profile"
                      >
