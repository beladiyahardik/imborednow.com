      ...
      <section className="bg-white py-24 px-6 border-t border-slate-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            In this module, we simulate basic signal processing. The brain must
            map a path across a 2D matrix while accounting for 90-degree vector
            shifts. This exercises the <strong>parietal lobe</strong>, improving
