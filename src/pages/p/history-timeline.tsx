...
export default function HistoryOnYourBirthday() {
  ...
  const historyEvents = [
    ...
    { year: 1066, month: 10, day: 14, event: "Battle of Hastings - Norman Conquest ⚔️🇬🇧" },
    { year: 1096, month: 11, day: 27, event: "First Crusade Begins ⚔️✝️" },
    { year: 1215, month: 6, day: 15, event: "Magna Carta Signed 📜" },
    { year: 1271, month: 1, day: 1, event: "Marco Polo Begins Journey to China 🧭" },
    ...
    { year: 1517, month: 10, day: 31, event: "Martin Luther's 95 Theses - Protestant Reformation ✝️" },
    ...
    { year: 1620, month: 11, day: 21, event: "Mayflower Pilgrims Land at Plymouth Rock 🇺🇸⛵" },
    { year: 1642, month: 8, day: 22, event: "English Civil War Begins ⚔️👑" },
    { year: 1649, month: 1, day: 30, event: "Execution of King Charles I 🗡️👑" },
    { year: 1687, month: 7, day: 5, event: "Newton Publishes Principia Mathematica 📐" },
    { year: 1707, month: 5, day: 1, event: "Act of Union - United Kingdom Formed 🇬🇧" },
    { year: 1756, month: 1, day: 1, event: "Seven Years' War Begins ⚔️🌍" },
    { year: 1769, month: 1, day: 1, event: "James Watt Patents Steam Engine 🚂" },
    { year: 1773, month: 12, day: 16, event: "Boston Tea Party ☕🇺🇸" },
    { year: 1776, month: 7, day: 4, event: "US Declaration of Independence 🇺🇸📜" },
    ...
    { year: 1825, month: 9, day: 27, event: "First Passenger Railway Opens 🚂" },
    { year: 1837, month: 6, day: 20, event: "Queen Victoria Begins Reign 👑🇬🇧" },
    { year: 1848, month: 2, day: 24, event: "Communist Manifesto Published 📕" },
    { year: 1853, month: 7, day: 8, event: "Commodore Perry Opens Japan ⛵🇯🇵" },
    { year: 1857, month: 5, day: 10, event: "Indian Rebellion Against British Rule 🇮🇳" },
    { year: 1859, month: 11, day: 24, event: "Darwin Publishes Origin of Species 🦍📖" },
    ...
    { year: 1876, month: 3, day: 10, event: "First Telephone Call by Alexander Graham Bell ☎️" },
    ...
    { year: 1905, month: 1, day: 22, event: "Bloody Sunday in Russia - 1905 Revolution 🇷🇺" },
    { year: 1905, month: 6, day: 30, event: "Einstein Publishes Theory of Relativity 🧑‍🔬" },
    { year: 1911, month: 10, day: 10, event: "Chinese Revolution - End of Qing Dynasty 🇨🇳" },
    { year: 1912, month: 4, day: 15, event: "Sinking of the Titanic 🚢💔" },
    { year: 1914, month: 6, day: 28, event: "Assassination of Archduke Franz Ferdinand 🔫" },
    ...
    { year: 1918, month: 11, day: 11, event: "World War I Ends - Armistice Day 🕊️" },
    { year: 1919, month: 6, day: 28, event: "Treaty of Versailles Signed 📜" },
    { year: 1920, month: 8, day: 26, event: "19th Amendment - Women's Suffrage in US 🗳️♀️" },
    { year: 1922, month: 10, day: 28, event: "Mussolini's March on Rome - Fascism Rises 🇮🇹" },
    { year: 1922, month: 12, day: 30, event: "Soviet Union Officially Formed 🚩" },
    { year: 1923, month: 11, day: 8, event: "Beer Hall Putsch - Hitler's Failed Coup 🇩🇪" },
    { year: 1927, month: 5, day: 21, event: "Lindbergh Completes First Solo Transatlantic Flight ✈️🌊" },
    { year: 1928, month: 9, day: 28, event: "Fleming Discovers Penicillin 💊" },
    { year: 1929, month: 10, day: 29, event: "Wall Street Crash - Great Depression Begins 📉💔" },
    { year: 1933, month: 1, day: 30, event: "Hitler Becomes Chancellor of Germany 🇩🇪" },
    { year: 1936, month: 7, day: 17, event: "Spanish Civil War Begins ⚔️🇪🇸" },
    { year: 1937, month: 12, day: 13, event: "Rape of Nanking 💔🇨🇳" },
    { year: 1939, month: 9, day: 1, event: "Germany Invades Poland - Start of WWII ⚡🇵🇱" },
    { year: 1940, month: 5, day: 10, event: "Churchill Becomes British Prime Minister 🇬🇧" },
    { year: 1940, month: 6, day: 22, event: "France Surrenders to Germany 🇫🇷🏳️" },
    { year: 1940, month: 7, day: 10, event: "Battle of Britain Begins ✈️🇬🇧" },
    { year: 1941, month: 6, day: 22, event: "Germany Invades Soviet Union - Operation Barbarossa ❄️🇩🇪🇷🇺" },
    { year: 1941, month: 12, day: 7, event: "Pearl Harbor Attack 🇯🇵💣🇺🇸" },
    { year: 1942, month: 6, day: 4, event: "Battle of Midway - Turning Point in Pacific ⚓" },
    { year: 1942, month: 8, day: 23, event: "Battle of Stalingrad Begins ❄️⚔️" },
    { year: 1943, month: 2, day: 2, event: "German Defeat at Stalingrad 🇷🇺⚔️" },
    { year: 1944, month: 6, day: 6, event: "D-Day - Allied Invasion of Normandy 🌊⚔️" },
    { year: 1945, month: 4, day: 30, event: "Hitler Commits Suicide 🇩🇪⚰️" },
    { year: 1945, month: 5, day: 8, event: "Victory in Europe Day - VE Day 🇪🇺🎉" },
    { year: 1945, month: 8, day: 6, event: "Atomic Bomb Dropped on Hiroshima 💣☢️" },
    ...
    { year: 1948, month: 6, day: 24, event: "Berlin Blockade Begins - Cold War Intensifies ✈️🧱" },
    { year: 1949, month: 4, day: 4, event: "NATO Founded 🛡️" },
    { year: 1949, month: 8, day: 29, event: "Soviet Union Tests First Atomic Bomb ☢️🇷🇺" },
    { year: 1949, month: 10, day: 1, event: "People's Republic of China Founded 🇨🇳☭" },
    ...
    { year: 1954, month: 5, day: 7, event: "Fall of Dien Bien Phu - French Defeat in Vietnam 🇻🇳" },
    { year: 1954, month: 5, day: 17, event: "Brown v. Board of Education - School Desegregation 🏫🇺🇸" },
    { year: 1955, month: 12, day: 1, event: "Rosa Parks' Bus Boycott Begins 🚌✊" },
    { year: 1956, month: 10, day: 23, event: "Hungarian Revolution Against Soviet Rule 🇭🇺" },
    { year: 1957, month: 3, day: 25, event: "Treaty of Rome - European Economic Community 🇪🇺" },
    { year: 1957, month: 10, day: 4, event: "Sputnik Launched - Space Age Begins 🛰️🚀" },
    { year: 1959, month: 1, day: 1, event: "Cuban Revolution - Castro Takes Power 🇨🇺☭" },
    { year: 1960, month: 2, day: 1, event: "Greensboro Sit-ins - Civil Rights Movement 🪑✊" },
    { year: 1961, month: 4, day: 12, event: "Yuri Gagarin - First Human in Space 🚀👨‍🚀" },
    { year: 1961, month: 4, day: 17, event: "Bay of Pigs Invasion 🇨🇺🇺🇸" },
    { year: 1961, month: 8, day: 13, event: "Berlin Wall Construction Begins 🧱🇩🇪" },
    { year: 1962, month: 10, day: 16, event: "Cuban Missile Crisis Begins ☢️🇨🇺🇺🇸" },
    { year: 1963, month: 6, day: 16, event: "Valentina Tereshkova - First Woman in Space 🚀👩‍🚀" },
    { year: 1963, month: 8, day: 28, event: "Martin Luther King Jr.'s 'I Have a Dream' Speech ✊🎤" },
    { year: 1963, month: 11, day: 22, event: "JFK Assassination 🇺🇸💔" },
    { year: 1964, month: 8, day: 2, event: "Gulf of Tonkin Incident - Vietnam War Escalates 🇻🇳" },
    { year: 1965, month: 3, day: 7, event: "Bloody Sunday - Selma to Montgomery March ✊" },
    { year: 1966, month: 5, day: 16, event: "Cultural Revolution Begins in China 🇨🇳" },
    { year: 1967, month: 6, day: 5, event: "Six-Day War 🇮🇱⚔️" },
    { year: 1968, month: 1, day: 30, event: "Tet Offensive in Vietnam 🇻🇳⚔️" },
    { year: 1968, month: 4, day: 4, event: "Martin Luther King Jr. Assassinated ✊💔" },
    { year: 1968, month: 6, day: 5, event: "Robert F. Kennedy Assassinated 🇺🇸💔" },
    ...
    { year: 1973, month: 1, day: 27, event: "Paris Peace Accords - Vietnam War Ends 🇻🇳" },
    { year: 1973, month: 10, day: 6, event: "Yom Kippur War Begins 🇮🇱⚔️" },
    { year: 1973, month: 10, day: 17, event: "OPEC Oil Embargo Begins ⛽📉" },
    { year: 1974, month: 8, day: 8, event: "Nixon Resigns - Watergate Scandal 🇺🇸" },
    { year: 1975, month: 4, day: 30, event: "Fall of Saigon - End of Vietnam War 🇻🇳🚁" },
    { year: 1976, month: 9, day: 9, event: "Mao Zedong Dies 🇨🇳⚰️" },
    { year: 1978, month: 11, day: 18, event: "Jonestown Mass Suicide 💔" },
    { year: 1979, month: 1, day: 16, event: "Iranian Revolution - Shah Flees 🇮🇷" },
    { year: 1979, month: 2, day: 11, event: "Ayatollah Khomeini Returns to Iran ☪️🇮🇷" },
    ...
    { year: 1983, month: 9, day: 1, event: "Korean Air Flight 007 Shot Down 🇰🇷✈️" },
    { year: 1984, month: 10, day: 31, event: "Indira Gandhi Assassinated 🇮🇳" },
    { year: 1984, month: 12, day: 3, event: "Bhopal Gas Disaster 🇮🇳💨" },
    { year: 1985, month: 3, day: 11, event: "Gorbachev Becomes Soviet Leader 🇷🇺" },
    { year: 1986, month: 1, day: 28, event: "Space Shuttle Challenger Disaster 🚀💔" },
    { year: 1986, month: 4, day: 26, event: "Chernobyl Nuclear Disaster ☢️🇺🇦" },
    { year: 1987, month: 10, day: 19, event: "Black Monday Stock Market Crash 📉" },
    ...
    { year: 1991, month: 1, day: 17, event: "Gulf War Begins - Operation Desert Storm ⚔️🇮🇶" },
    { year: 1991, month: 6, day: 25, event: "Croatia and Slovenia Declare Independence 🇭🇷🇸🇮" },
    { year: 1991, month: 8, day: 19, event: "Soviet Coup Attempt Fails 🇷🇺" },
    { year: 1991, month: 12, day: 26, event: "Soviet Union Officially Dissolves 🇷🇺➡️15 countries" },
    { year: 1992, month: 4, day: 29, event: "Los Angeles Riots 🇺🇸🔥" },
    { year: 1992, month: 8, day: 1, event: "Bosnian War Begins 🇧🇦⚔️" },
    { year: 1993, month: 2, day: 26, event: "First World Trade Center Bombing 🇺🇸💣" },
    { year: 1994, month: 4, day: 6, event: "Rwandan Genocide Begins 🇷🇼💔" },
    { year: 1994, month: 4, day: 27, event: "Nelson Mandela Elected - First Democratic South African Election 🗳️🇿🇦" },
    { year: 1994, month: 12, day: 11, event: "First Chechen War Begins 🇷🇺" },
    { year: 1995, month: 3, day: 20, event: "Tokyo Subway Sarin Gas Attack 🇯🇵☣️" },
    ...
    { year: 1997, month: 8, day: 31, event: "Princess Diana Dies in Car Crash 💔🇬🇧" },
    ...
    { year: 2003, month: 2, day: 1, event: "Space Shuttle Columbia Disaster 🚀💔" },
    { year: 2003, month: 3, day: 20, event: "Iraq War Begins - US Invasion 🇮🇶⚔️" },
    ...
    { year: 2005, month: 8, day: 29, event: "Hurricane Katrina Hits New Orleans 🌀🇺🇸" },
    { year: 2006, month: 7, day: 12, event: "Israel-Lebanon War Begins 🇮🇱🇱🇧" },
    { year: 2006, month: 12, day: 30, event: "Saddam Hussein Executed 🇮🇶" },
    { year: 2007, month: 6, day: 29, event: "iPhone Released - Smartphone Revolution 📱" },
    ...
    { year: 2010, month: 12, day: 17, event: "Arab Spring Begins in Tunisia 🇹🇳✊" },
    { year: 2011, month: 1, day: 25, event: "Egyptian Revolution Begins 🇪🇬✊" },
    { year: 2011, month: 2, day: 11, event: "Mubarak Resigns in Egypt 🇪🇬" },
    { year: 2011, month: 3, day: 11, event: "Fukushima Nuclear Disaster 🌊☢️🇯🇵" },
    { year: 2011, month: 3, day: 15, event: "Syrian Civil War Begins 🇸🇾⚔️" },
    { year: 2011, month: 5, day: 2, event: "Osama bin Laden Killed in Pakistan 🇵🇰" },
    { year: 2011, month: 10, day: 20, event: "Muammar Gaddafi Killed in Libya 🇱🇾" },
    { year: 2012, month: 10, day: 29, event: "Hurricane Sandy Hits US East Coast 🌀🇺🇸" },
    { year: 2012, month: 12, day: 14, event: "Sandy Hook School Shooting 🇺🇸💔" },
    ...
    { year: 2014, month: 6, day: 29, event: "ISIS Declares Caliphate in Iraq & Syria ☪️⚔️" },
    { year: 2014, month: 7, day: 17, event: "Malaysia Airlines MH17 Shot Down Over Ukraine ✈️💔" },
    { year: 2014, month: 8, day: 9, event: "Ferguson Protests Begin - Black Lives Matter Movement 🇺🇸✊" },
    { year: 2014, month: 12, day: 16, event: "Peshawar School Massacre 🇵🇰💔" },
    { year: 2015, month: 1, day: 7, event: "Charlie Hebdo Attack in Paris 🇫🇷💔" },
    { year: 2015, month: 4, day: 25, event: "Nepal Earthquake - Nearly 9,000 Dead 🇳🇵💔" },
    { year: 2015, month: 7, day: 14, event: "Iran Nuclear Deal Signed 🇮🇷☢️" },
    { year: 2015, month: 9, day: 30, event: "Russia Begins Military Intervention in Syria 🇷🇺🇸🇾" },
    { year: 2015, month: 11, day: 13, event: "Paris Terrorist Attacks - Bataclan Theatre 🇫🇷💔" },
    { year: 2016, month: 6, day: 12, event: "Orlando Nightclub Shooting 🇺🇸💔" },
    { year: 2016, month: 6, day: 23, event: "Brexit Referendum - UK Votes to Leave EU 🇬🇧🇪🇺" },
    { year: 2016, month: 7, day: 15, event: "Turkey Coup Attempt Fails 🇹🇷" },
    { year: 2016, month: 11, day: 8, event: "Donald Trump Elected US President 🇺🇸" },
    { year: 2016, month: 11, day: 26, event: "Fidel Castro Dies 🇨🇺⚰️" },
    { year: 2017, month: 1, day: 20, event: "Donald Trump Inaugurated as US President 🇺🇸" },
    { year: 2017, month: 10, day: 1, event: "Las Vegas Mass Shooting 🇺🇸💔" },
    { year: 2017, month: 10, day: 5, event: "#MeToo Movement Goes Viral 📱✊" },
    { year: 2017, month: 10, day: 27, event: "Catalonia Declares Independence from Spain 🇪🇸" },
    { year: 2017, month: 12, day: 6, event: "US Recognizes Jerusalem as Israel's Capital 🇮🇱🇺🇸" },
    { year: 2018, month: 2, day: 14, event: "Parkland School Shooting 🇺🇸💔" },
    { year: 2018, month: 3, day: 4, event: "Sergei Skripal Poisoning in UK 🇬🇧🇷🇺" },
    { year: 2018, month: 6, day: 12, event: "Trump-Kim Summit in Singapore 🇺🇸🇰🇵" },
    { year: 2018, month: 10, day: 2, event: "Jamal Khashoggi Murdered 🇸🇦💔" },
    { year: 2019, month: 3, day: 15, event: "Christchurch Mosque Shootings 🇳🇿💔" },
    ...
    { year: 2020, month: 3, day: 11, event: "WHO Declares COVID-19 Pandemic 🦠" },
    { year: 2020, month: 5, day: 25, event: "George Floyd Killed - Global BLM Protests ✊🇺🇸" },
    { year: 2020, month: 8, day: 4, event: "Beirut Explosion 🇱🇧💥" },
    { year: 2020, month: 11, day: 3, event: "US Presidential Election - Biden vs Trump 🇺🇸🗳️" },
    { year: 2020, month: 12, day: 8, event: "First COVID-19 Vaccines Administered 💉" },
    { year: 2021, month: 1, day: 6, event: "US Capitol Riot 🇺🇸🏛️" },
    { year: 2021, month: 1, day: 20, event: "Joe Biden Inaugurated as US President 🇺🇸" },
    { year: 2021, month: 2, day: 1, event: "Myanmar Military Coup 🇲🇲" },
    { year: 2021, month: 3, day: 23, event: "Suez Canal Blocked by Ever Given Ship 🚢" },
    { year: 2021, month: 4, day: 20, event: "Derek Chauvin Found Guilty of George Floyd Murder ⚖️" },
    { year: 2021, month: 8, day: 15, event: "Taliban Takes Control of Afghanistan 🇦🇫" },
    { year: 2021, month: 9, day: 8, event: "Queen Elizabeth II Dies 👑🇬🇧⚰️" },
    { year: 2021, month: 11, day: 5, event: "Travis Scott Astroworld Festival Tragedy 🇺🇸💔" },
    { year: 2022, month: 2, day: 4, event: "Beijing Winter Olympics Begin 🇨🇳⛷️" },
    { year: 2022, month: 2, day: 24, event: "Russia Invades Ukraine - Full-Scale War Begins 🇺🇦🇷🇺💥" },
    { year: 2022, month: 5, day: 24, event: "Uvalde School Shooting 🇺🇸💔" },
    { year: 2022, month: 6, day: 24, event: "Roe v. Wade Overturned by US Supreme Court 🇺🇸⚖️" },
    { year: 2022, month: 9, day: 8, event: "Queen Elizabeth II Dies at Age 96 👑🇬🇧⚰️" },
    { year: 2022, month: 9, day: 16, event: "Mahsa Amini Dies - Iran Protests Begin 🇮🇷✊" },
    { year: 2022, month: 11, day: 30, event: "ChatGPT Released by OpenAI 🤖💬" },
    { year: 2022, month: 12, day: 18, event: "Argentina Wins FIFA World Cup 🇦🇷⚽🏆" },
    { year: 2023, month: 1, day: 6, event: "Brazil Congress Riots 🇧🇷" },
    { year: 2023, month: 2, day: 6, event: "Turkey-Syria Earthquake - Over 50,000 Dead 🇹🇷🇸🇾💔" },
    { year: 2023, month: 6, day: 18, event: "Titan Submersible Implosion 🌊💔" },
    { year: 2023, month: 6, day: 23, event: "Wagner Group Mutiny in Russia 🇷🇺" },
    { year: 2023, month: 8, day: 8, event: "Maui Wildfires - Lahaina Destroyed 🇺🇸🔥" },
    { year: 2023, month: 10, day: 7, event: "Hamas Attacks Israel - Gaza War Begins 🇮🇱🇵🇸⚔️" },
    { year: 2023, month: 11, day: 17, event: "Sam Altman Fired then Reinstated at OpenAI 🤖" },
    { year: 2024, month: 1, day: 1, event: "Japan Earthquake - Noto Peninsula 🇯🇵💔" },
    { year: 2024, month: 3, day: 22, event: "Moscow Concert Hall Attack 🇷🇺💔" },
    { year: 2024, month: 4, day: 3, event: "Israel Strikes Iranian Consulate in Syria 🇮🇱🇮🇷" },
    { year: 2024, month: 4, day: 13, event: "Iran Attacks Israel with Drones and Missiles 🇮🇷🇮🇱" },
    { year: 2024, month: 5, day: 19, event: "Iranian President Raisi Dies in Helicopter Crash 🇮🇷⚰️" },
    { year: 2024, month: 7, day: 13, event: "Trump Assassination Attempt at Rally 🇺🇸" },
    { year: 2024, month: 7, day: 21, event: "Biden Withdraws from 2024 Presidential Race 🇺🇸" },
    { year: 2024, month: 7, day: 26, event: "Paris Summer Olympics Begin 🇫🇷🏅" },
    { year: 2024, month: 9, day: 17, event: "Lebanon Pager Explosions 🇱🇧💥" },
    { year: 2024, month: 10, day: 1, event: "Iran Launches Missile Barrage at Israel 🇮🇷🇮🇱" },
    { year: 2024, month: 10, day: 7, event: "One Year Anniversary of Gaza War 🇮🇱🇵🇸" },
    { year: 2024, month: 11, day: 5, event: "Donald Trump Elected 47th US President 🇺🇸" },
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50">
        ...
        <section className="relative overflow-hidden py-20 sm:py-32">
          ...
          <div className="relative container mx-auto px-4 sm:px-6 text-center text-white">
            ...
            <p className="text-xl sm:text-3xl font-medium opacity-95 max-w-4xl mx-auto mb-12">
              Enter your birthdate to see only the major world events that happened <strong>during your lifetime</strong> — and how old you were!
            </p>
        ...
        {/* Results */}
        {showResults && (
          <section ref={resultsRef} className="py-16 sm:py-24 bg-white/60 backdrop-blur-sm">
              ...
              {events.length > 0 ? (
                ...
                <div className="text-center py-20">
                  ...
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    Not many of these historical events have happened since you were born yet.
                    <br />
                    But you're living through history right now — and the future is yours to shape! 🚀
                  </p>
                </div>
              )}
        ...
        <section className="py-16 bg-gradient-to-br from-purple-100 to-pink-100">
          <div className="container mx-auto px-4 sm:px-6 text-center max-w-4xl">
            ...
            <p className="text-xl sm:text-2xl leading-relaxed text-gray-800">
              Every generation thinks they're living in the most important time in history.
              <br />
        ...
        <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-10 sm:py-12">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-gray-400">© 2025 I'm Bored Now. Your Life. Real History. ❤️</p>
          </div>
        </footer>
      </div>
    </>
