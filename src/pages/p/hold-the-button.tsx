...
export default function HoldTheButtonGame() {
  ...
  const stopTimer = useCallback(() => {
    ...
    if (currentTime > 30) {
      const name = prompt(
        `Incredible! 💥 You held for ${formatTime(
          currentTime
        )}!\nEnter your name:`
      );
      if (name?.trim()) {
          ...
          <section className="py-12 sm:py-24 relative z-10">
            <div className="container mx-auto px-6 text-center">
              ...
              >
                ...
                {/* Side Shadows */}
                <div
                  className={`absolute inset-0 rounded-3xl shadow-[4px_4px_12px_rgba(0,0,0,0.3), inset_-4px_-4px_8px_rgba(255,255,255,0.4)] transition-all duration-200 ${
                    isPressed
                      ? "shadow-[2px_2px_6px_rgba(0,0,0,0.5), inset_-2px_-2px_12px_rgba(255,255,255,0.2)]"
                      : ""
                  }`}
                />
                ...
                {/* Bottom Shadow */}
                <div
                  className={`absolute -bottom-8 left-1/2 -translate-x-1/2 w-4/5 h-8 bg-gradient-to-t from-black/40 to-transparent rounded-full blur-xl transition-all ${
              ...
              <div className="mt-20 max-w-2xl mx-auto">
                <div className="w-full bg-gray-200 rounded-full h-6 shadow-inner overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min((currentTime / 300) * 100, 100)}%`,
                    }}
                  >
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-8">
                        ...
                        <div>
                          <h3 className="text-4xl font-black drop-shadow-lg mb-2">
                            {entry.name}
                          </h3>
