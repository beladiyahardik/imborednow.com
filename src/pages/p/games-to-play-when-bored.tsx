...
export default function GamesArchive() {
  ...
  const games = [
    ...
    },
    {
      title: "Grid Pulse",
      icon: "⚡",
      desc: "A high-speed reflex test. Sync with the grid pulses before they vanish.",
      url: "/p/grid-pulse",
      tag: "Reflex",
      hot: true,
      difficulty: "Medium",
    },
    {
      title: "Cipher Grid",
      icon: "🔐",
      desc: "Decipher the hidden sequence. A high-stakes test of deductive reasoning.",
      url: "/p/cipher-grid",
      tag: "Logic",
      hot: true,
      difficulty: "Hard",
    },
    {
      title: "Neural Link",
      icon: "🧠",
      desc: "Match the fast-flashing neural sequence. A high-speed test of pattern recall.",
      url: "/p/neural-link",
      tag: "Memory",
      hot: true,
      difficulty: "Medium",
