...
const dadJokes = [
  ...
  { q: "Why don't scientists trust stairs?", a: "They're always up to something!" },
  ...
  { q: "Why don't basketball players go on vacation?", a: "They'd get called for traveling!" },
  ...
  { q: "Why did the math teacher open a window company?", a: "She loved working with panes!" },
  { q: "What do you call a train carrying bubble gum?", a: "A chew-chew train!" },
  ...
  { q: "Why don't teddy bears ever eat dessert?", a: "They're always stuffed!" },
  ...
  { q: "Why don't eggs tell each other secrets?", a: "They might crack under pressure!" },
  ...
  { q: "Why did the restaurant on the moon get bad reviews?", a: "No atmosphere!" },
  ...
  { q: "Why did the scarecrow become a successful motivational speaker?", a: "He was outstanding in his field!" },
  ...
  { q: "What did the Atlantic Ocean say to the Pacific Ocean?", a: "Nothing, they just waved!" },
  ...
  { q: "What did the mayonnaise say when the refrigerator door was opened?", a: "Close the door, I'm dressing!" },
  ...
  { q: "How do you make a million dollars?", a: "Start with a billion dollars and launch an airline!" },
  { q: "What did the horse say after it tripped?", a: "Help, I've fallen and I can't giddyup!" },
  ...
  { q: "Why don't elevators ever get tired?", a: "They're good at letting things go!" },
  ...
  { q: "What did the cell phone say to the other cell phone?", a: "Can you hear me now?" },
  { q: "Why don't melons get married?", a: "Because they cantaloupe!" },
  { q: "What do you call a snowman party?", a: "A snowball!" },
  { q: "How do you make a unicorn float?", a: "Two scoops of ice cream, root beer, and a unicorn!" },
  { q: "What did the doctor say to the rocket ship?", a: "Time to get your booster shot!" },
  { q: "Why don't calendars ever go on vacation?", a: "Their days are numbered!" },
  ...
  { q: "What do you call a potato that's always getting into trouble?", a: "A medi-tater!" },
  { q: "How do you make a lemon sad?", a: "Take away its zest for life!" },
  { q: "What did the big bucket say to the little bucket?", a: "Looking a little pail!" },
  ...
  { q: "What did the left shoe say to the right shoe?", a: "I think we make a great pair!" },
  ...
  { q: "How do you make a musician laugh?", a: "Tell them a note-worthy joke!" },
  { q: "What did the stoplight say to the car?", a: "Don't look, I'm changing!" },
  { q: "Why don't clouds ever go to college?", a: "They already have degrees!" },
  { q: "What do you call a cow with a twitch?", a: "Beef jerky!" },
  { q: "How do you make a pirate angry?", a: "Take away the 'p'!" },
  { q: "Why don't pencils ever go to parties?", a: "They're afraid they'll get too sharp!" },
  ...
  { q: "How do you make a sad banana happy?", a: "Give it a bunch of friends!" },
  ...
  { q: "How do you make a tissue box smile?", a: "Tell it a sneeze-worthy joke!" },
  { q: "Why don't planets ever get lonely?", a: "They're always in orbit with friends!" },
  ...
  { q: "Why don't magnets ever go to school?", a: "They find it too attractive!" },
  { q: "How do you make a balloon laugh?", a: "Tickle it until it pops!" },
  { q: "What did the hurricane say to the coconut tree?", a: "Hold on to your nuts, this is no ordinary blowjob!" },
  ...
  { q: "Why don't batteries ever feel tired?", a: "They're always charged up!" },
  ...
  { q: "What did the dad spider say to his baby spider?", a: "You spend too much time on the web!" },
  { q: "Why don't pencils ever win arguments?", a: "They always have to erase their mistakes!" },
  ...
  { q: "Why don't shoes ever get tired?", a: "They're always getting a sole workout!" },
  { q: "What do you call a rabbit with fleas?", a: "Bugs Bunny!" },
  { q: "How do you make a vegetable laugh?", a: "Tell it a corny joke!" },
  { q: "What did the frog say when it got a flat tire?", a: "Nothing, it just jump-started its car!" },
  { q: "Why don't spoons ever get invited to parties?", a: "They're always stirring things up!" },
  ...
  { q: "What did the traffic light say to the other traffic light?", a: "Don't look, I'm changing!" },
  { q: "Why don't printers ever get invited to parties?", a: "They always jam!" },
  ...
  { q: "What do you call a book club that's been stuck on one book for years?", a: "Church!" },
  { q: "How do you make a tennis ball stop bouncing?", a: "Let it retire!" },
  { q: "What did the broom say to the dustpan?", a: "Let's sweep the competition!" },
  ...
  { q: "Why don't erasers ever remember anything?", a: "They always rub things out!" },
  ...
  { q: "Why don't staplers ever get separated?", a: "They're always attached!" },
  { q: "What do you call a cat that swallowed a ball of yarn?", a: "A ball of fur!" },
  ...
  { q: "How do you make a vacuum cleaner happy?", a: "Give it something to suck up to!" },
  { q: "What did the wallet say to the money?", a: "You're so valuable!" },
  { q: "Why don't rulers ever bend the truth?", a: "They're always straight with you!" },
  { q: "What do you call a sleeping computer?", a: "A screen-saver!" },
  { q: "How do you make a lamp bright?", a: "Tell it an illuminating joke!" },
  { q: "What did the hammer say to the nail?", a: "You're getting hammered tonight!" },
  { q: "Why don't doorknobs ever get dizzy?", a: "They're used to turning around!" },
  { q: "What do you call a nervous wreck?", a: "My first time parallel parking!" },
  { q: "How do you make a toaster laugh?", a: "Pop a joke in it!" },
  { q: "What did the comb say to the hair?", a: "I'm bristling with excitement!" },
  { q: "Why don't doorbells ever get tired?", a: "They're always getting rung up!" },
  { q: "What do you call a sleeping accountant?", a: "Out for the count!" },
  { q: "How do you make a washing machine happy?", a: "Give it a load of fun!" },
  { q: "What did the scissors say to the paper?", a: "Cut it out!" },
  { q: "Why don't glasses ever see eye to eye?", a: "They're too focused on different things!" },
  ...
  { q: "Why don't curtains ever hide their feelings?", a: "They're too transparent!" },
  ...
  { q: "Why don't cushions ever feel uncomfortable?", a: "They're always padding their answers!" },
  ...
  { q: "Why don't bottles ever spill secrets?", a: "They keep things bottled up!" },
  { q: "What do you call a sleeping baker?", a: "Bread in bed!" },
  { q: "How do you make a scale happy?", a: "Give it something to weigh in on!" },
  ...
  { q: "Why don't shelves ever feel empty?", a: "They're always supporting something!" },
  { q: "What do you call a sleeping plumber?", a: "Drain-ing his energy!" },
  { q: "How do you make a refrigerator cool?", a: "Tell it an ice joke!" },
  { q: "What did the mirror say to the person?", a: "I reflect your greatness!" },
  ...
  { q: "Why don't hangers ever let things drop?", a: "They're always hanging in there!" },
  { q: "What do you call a sleeping firefighter?", a: "Dead tired!" },
  { q: "How do you make a telephone laugh?", a: "Ring its bell!" },
  { q: "What did the toothbrush say to the toothpaste?", a: "You complete me!" },
  { q: "Why don't cabinets ever reveal secrets?", a: "They keep things under wraps!" },
  ...
  { q: "Why don't hinges ever crack under pressure?", a: "They're well-oiled!" },
  { q: "What do you call a sleeping electrician?", a: "Currently unavailable!" },
  { q: "How do you make a garden hose laugh?", a: "Turn on the water works!" },
  { q: "What did the dustpan say to the broom?", a: "You sweep me off my feet!" },
  { q: "Why don't screws ever come undone?", a: "They're always screwing around!" },
  ...
  { q: "How do you make a chisel happy?", a: "Give it something to chip away at!" },
  ...
  { q: "What did the sandpaper say to the wood?", a: "I'm rough around the edges!" },
  ...
  { q: "What do you call a sleeping roofer?", a: "Shingle and ready to mingle!" },
  { q: "How do you make a compass laugh?", a: "Point it in the right direction!" },
  ...
  { q: "What did the cement mixer say to the concrete?", a: "Let's get mixed up!" },
  { q: "Why don't pipe wrenches ever slip up?", a: "They have a good grip!" },
  { q: "What do you call a nervous carpenter?", a: "Board stiff!" },
  { q: "How do you make a utility knife happy?", a: "Give it something to cut into!" },
  ...
  { q: "What did the concrete saw say to the concrete?", a: "Let's cut to the chase!" },
  { q: "Why don't wire strippers ever feel naked?", a: "They're comfortable in their own skin!" },
  ...
  { q: "Why don't torque wrenches ever overdo it?", a: "They know their limits!" },
  { q: "What do you call a nervous glazier?", a: "Pane-ful!" },
  { q: "How do you make a multimeter happy?", a: "Give it something to measure!" },
...
export default function DadJokesPage() {
  ...
  const handleNextJoke = () => {
    confetti({
      ...
      spread: 80,
      origin: { y: 0.6 },
      colors: ["#fbbf24", "#f472b6", "#a78bfa", "#34d399", "#60a5fa", "#fb923c"],
    });
  ...
  return (
    <>
      <Head>
        <title>Dad Jokes Unlimited 😂 | {dadJokes.length} Classic Groaners</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-100 via-orange-100 to-rose-100 relative overflow-hidden">
        ...
        <section className="relative flex items-center justify-center min-h-screen py-20 px-6">
          <div className="max-w-5xl w-full">
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-4xl p-12 md:p-24 text-center border-8 border-amber-400">
              <h1 className="text-5xl md:text-8xl font-black bg-clip-text text-transparent bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 mb-16 drop-shadow-2xl">
                Dad Jokes Unlimited 😂
              </h1>

              {/* Question */}
              <div className="mb-20">
                <p className="text-3xl md:text-6xl font-bold text-gray-800 leading-relaxed tracking-wide">
                  {currentJoke.q}
                </p>
              </div>

              {/* What? Button or Answer + Next */}
              {!showAnswer ? (
                <button
                  onClick={() => setShowAnswer(true)}
                  className="px-20 py-10 text-5xl font-extrabold text-white bg-gradient-to-r from-blue-600 to-purple-700 rounded-full shadow-3xl hover:shadow-purple-600/70 hover:scale-110 transform transition-all duration-500"
                >
                  What? 🤨
                </button>
              ) : (
                <>
                  <div className="animate-fade-in mb-20">
                    <p className="text-4xl md:text-7xl font-extrabold text-emerald-700 leading-relaxed drop-shadow-lg">
                      {currentJoke.a}
                    </p>
                  </div>
                  ...
                  <button
                    ...
                    className="group px-24 py-12 text-5xl font-black text-white bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full shadow-4xl hover:shadow-teal-600/70 hover:scale-110 transform transition-all duration-500 flex items-center justify-center gap-8 mx-auto"
                  >
                    Another One! 🎉
                    <span className="text-6xl group-hover:rotate-360 transition-transform duration-1000">
                      🔄
                    </span>
                  </button>
                </>
            ...
            <div className="text-center mt-16 text-gray-700">
              <p className="text-2xl font-semibold">
                Joke #{currentIndex + 1} of <span className="text-amber-600 font-black text-3xl">{dadJokes.length}</span> ultimate dad jokes
              </p>
              <p className="mt-4 text-lg italic">Warning: Excessive groaning may occur</p>
            </div>
          </div>
        </section>
