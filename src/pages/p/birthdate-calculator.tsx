...
export default function MilestoneCalculator() {
    ...
    return (
        <>
            <Head>
                <title>Life Milestone Calculator - When Will You Hit 10,000 Days?</title>
                <meta
                    name="description"
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                                {milestones.map((milestone, index) => {
                                    ...
                                    return (
                                        <div
                                            key={milestone.days}
                                            className={`group relative p-8 rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-500 hover:-translate-y-4 hover:scale-105 animate-fade-up ${index < 3
                ...
                <section className="py-16 bg-gradient-to-br from-purple-100 to-pink-100">
                    <div className="container mx-auto px-4 sm:px-6 text-center max-w-4xl">
                        ...
                        <p className="text-xl sm:text-2xl leading-relaxed text-gray-800">
                            ...
                            <br />
                            That&apos;s only <span className="text-purple-600 font-bold">77 years</span> —
                ...
                <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-10 sm:py-12">
                    <div className="container mx-auto px-4 sm:px-6 text-center">
                        ...
                        <p className="text-gray-400">
                            © 2025 I'm Bored Now. Made with ❤️ to kill boredom.
                        </p>
                    </div>
                </footer>
            </div>
